...
import { OpenAIStream } from '@/src/lib/openai-stream';
import { createAPIHandler, validateBody } from '@/src/lib/api/handler';
import { createStreamResponse } from '@/src/lib/api/response';
import { ConfigurationError } from '@/src/lib/errors/api-errors';
import { OpenAIError } from '@/src/lib/errors/openai-errors';
import { z } from 'zod';
